...
const steps = ['Valitse huoltamo', 'Ajanvaraus', 'Varmistus'];

function getStepContent(step) {
    switch (step) {
        case 0:
            return <div style={{margin:"auto"}}><ValitseHuoltamo/></div>;
        case 1:
            ...
            <React.Fragment>
                ...
                <Toolbar style={{backgroundColor: bgColors.Blue,color: bgColors.white,padding:"4.5%"}}>
                    ...
                    <Grid
                        ...
                        alignItems="center"
                    >
                        <Typography variant="h4" color="inherit" className={classes.barText}>
                            Varaa huolto
                        </Typography>
                    </Grid>
                            ...
                            {activeStep === steps.length ? (
                                <React.Fragment>
                                    ...
                                    <Typography variant="subtitle1">
                                        Huollon tilausnumerosi on 01234567 ja huoltamon x numero on xxx
                                    </Typography>
                                </React.Fragment>
                            ) : (
                                <React.Fragment>
                                    ...
                                    <div className={classes.buttons}>
                                        ...
                                        >
                                            {activeStep === steps.length - 1 ? 'Varaa huolto' : 'Seuraava'}
                                        </Button>
                                    </div>
                                </React.Fragment>
                            )}

...
class Rekkaus extends React.Component{
    ...
    handlerek = () => {
        const user = {
            ...
            rekisteri: this.state.rekisteri,
            password: this.state.password,
        };

        axios
            .post("http://laravel.outgoingtraffic.bid/api/user/register", { user })
            .then(response => {
        ...
        return (
                                    ...
                                    <Paper className={classes.root} elevation={1}>
                                        ...
                                        <div className={classes.section2}>
                                            <TextField
                                                ...
                                                onChange={this.handleChange('etunimi')}
                                            />
                                        </div>
                                        ...
                                        <div className={classes.section2}>
                                            <TextField
                                                ...
                                                onChange={this.handleChange('sukunimi')}
                                            />
                                        </div>
                                        ...
                                        <div className={classes.section2}>
                                            <TextField
                                                ...
                                                fullWidth
                                                value={this.state.rekisteri}
                                                onChange={this.handleChange('rekisteri')}
                                            />
                                        </div>
            ...
            {/*                            <div className={classes.section2}>
                                        ...
                                        <div className={classes.section3}>
                                            <Button variant="contained" color="primary" fullWidth onClick={this.handlerek}>
                                                Rekisteröidy
                                            </Button>
                                        </div>

                                        <div className={classes.section3}>
                                            <Button variant="contained" color="default"  component={RouterLink} to={'/kirjaudu'} fullWidth>
                                                Kirjaudu
                                            </Button>
                                        </div>
...
export default withStyles(styles)(Rekkaus);